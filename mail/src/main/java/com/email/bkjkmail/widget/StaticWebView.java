package com.email.bkjkmail.widget;
...
public class StaticWebView extends WebView {
    ...
    public StaticWebView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    @SuppressLint("NewApi")
    public StaticWebView(Context context, AttributeSet attrs, int defStyle, boolean privateBrowsing) {
